...
class MultiGraph
{
    ...
    std::vector<float> haltEdge(const std::string &edgeName,
                                const std::string &vertexFromName,
                                const std::string &vertexToName);
    ...
    void traverseUsingEdges(std::vector<std::string> &airlines,
                            int airport,
                            std::vector<int> &tempVisited) const;

    int mostUnvisitedNeighbor(std::vector<int> &visited) const;

    void unusedAirline(std::vector<std::string> &airlines,
                      int airport,
    ...
    private:
    bool edgeInVector(const std::vector<std::string>& edgeNames,
